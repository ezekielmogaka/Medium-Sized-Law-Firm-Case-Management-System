                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box border blue">
                           ...
                           foreach ($attorneys as $lawyer){
	                       	      ...
	                       	      <td>
                           	       ".substr($lawyer['attorney_notes'], 0,600)."
                           	       </td>
                           	       ...
                           	       <td>
	                           	       <a href='".base_url()."index.php/admin/edit_attorney/".$lawyer['attorney_id']."' class='btn btn-success fa fa-edit'>Edit</a>
                           	       </td>

                           	       <td>
	                           	       <a href='".base_url()."index.php/admin/delete_attorney/".$lawyer['attorney_id']."' class='btn btn-danger fa fa-trash-o'>Delete</a>
                           	       </td>
                           	       </tr>";
                                   $counter++;
