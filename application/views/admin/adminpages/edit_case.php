                                          ...
                                          ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div data-date="2016-01-20T15:25:00Z" class="input-group date form_datetime-adv">
                                                        <input type="text" class="form-control" size="16" required id="incident_date" name="incident_date" value="<?php echo set_value('incident_date'); ?>">
