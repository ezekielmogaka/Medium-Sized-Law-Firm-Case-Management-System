    ...
    <div class="container">
        <div class="row">
            <div id="content" class="col-lg-12">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                          ...
                          echo validation_errors();
                           ...
                           echo form_open_multipart('admin/submit_edited_attorney', $form_attributes);
                          ?>
                                            <?php
                                                        foreach ($attorney_details as $detail){

                              
                                                        ?>
                                                <input type="hidden" id="attorney_id" name="attorney_id" required value="<?php echo $detail['attorney_id'];?>">
                                                <div class="form-group">
                                                    <label for="attorney_first_name" class="col-lg-3 col-sm-3 control-label">Attorney First Name</label>
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        <input type="text" class="form-control" id="attorney_first_name" name="attorney_first_name" required value="<?php echo $detail['attorney_first_name'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <input type="text" class="form-control" id="client_last_name" name="attorney_last_name" required value="<?php echo $detail['attorney_last_name'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <select class="form-control m-bot15" required id="attorney_speciality" name="attorney_speciality" value="<?php echo $detail['attorney_speciality'];?>">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-3 col-sm-3 control-label" for="employment_status">Employment Status</label>
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        <?php echo form_error('employment_status'); ?>
                                                        <select class="form-control m-bot15" required id="employment_status" name="employment_status" value="<?php echo $detail['employment_status'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <input type="text" class="form-control" id="attorney_phone" name="attorney_phone" required value="<?php echo $detail['attorney_phone'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div data-date="2012-12-21T15:25:00Z" class="input-group date form_datetime-meridian">
                                                            <input type="text" class="form-control" size="16" value="<?php echo $detail['employmentDate'];?>" required id="employmentDate" name="employmentDate">
                                                            <div class="input-group-btn">
                                                                <button type="button" class="btn btn-danger date-reset"><i class="fa fa-times"></i></button>
                                                                <button type="button" class="btn btn-info date-set"><i class="fa fa-calendar"></i></button>
                                                            </div>
                                                        </div>
                                                        <p class="help-block">Employment Date</p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <input type="text" class="form-control" id="nssfNo" name="nssfNo" required value="<?php echo $detail['nssfNo'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <input type="text" class="form-control" id="nhifNo" name="nhifNo" required value="<?php echo $detail['nhifNo'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <input type="email" class="form-control" id="attorney_email" name="attorney_email" required value="<?php echo $detail['attorney_email'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <input type="password" class="form-control" id="attorney_password" name="attorney_password" required value="<?php echo $detail['attorney_password'];?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <textarea class="wysihtml5 form-control" type="text" id="attorney_notes" name="attorney_notes" placeholder="Attorney profile e.g Educational backgroung...." rows="12" required value="<?php echo $detail['attorney_notes'];?>">
                                                            <?php echo $detail['attorney_notes'];?>
                                                        </textarea>
                        ...
                        ?>
                                                            <input type="file" class="form-control" id="attorney_cv" name="attorney_cv" value="<?php echo $detail['cv_full_path'];?>">
              ...
              ?>
                                                    <div class="form-group" style="margin-top:30px;">
                                                        <button type="submit" class="col-lg-offset-3 col-md-offset-3 col-md-6  col-sm-offset-3 col-sm-6 col-lg-6 btn btn-primary nextBtn">Update Attorney<i class="fa fa-arrow-circle-right"></i></button>
                                                    </div>
                                                    </form>
                                    </div>
                                </div>
            ...
            jQuery(document).ready(function() {
                App.setPage("edit_attorney"); //Set current page
