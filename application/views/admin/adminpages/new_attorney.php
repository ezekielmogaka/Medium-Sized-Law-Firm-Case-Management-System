		                  ...
		                  ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    <input type="text" class="form-control" id="attorney_first_name" name="attorney_first_name" required value="<?= set_value('attorney_first_name')?>">
                                            ...
                                            <div class="form-group">
                                      <label class="col-sm-3 col-sm-3 control-label">Speciality</label>
                                      <div class="col-lg-9">

                                      
                                          <select class="form-control m-bot15" id="attorney_speciality" name="attorney_speciality" required value="<?php echo set_value('attorney_speciality'); ?>">
                                          <option value="">-- Please Select Attorney Speciality --</option>
                                         
                                             <?php
                               foreach ($speciality as $spec) {
                                  echo "<option value='".$spec['matter_category_id']."'>".$spec['matter_category_name']."</option>";
                               }
                  ?>
                                          </select>
