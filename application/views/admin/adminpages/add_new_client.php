                    ...
                    <div class="col-md-12">
                        <div class="row">
		                  ...
		                  echo validation_errors();
		                   ...
		                   echo form_open_multipart('admin/submit_new_client', $form_attributes);
		                  ?>
                                            <div class="form-group">
                                                <label class="col-lg-3 col-sm-3 control-label" for="client_type">Client type</label>
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    <?php echo form_error('client_type'); ?>
                                                    <select class="form-control m-bot15" required id="client_type" name="client_type" value="<?= set_value('client_type')?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    <input type="text" class="form-control" id="client_first_name" name="client_first_name" required value="<?= set_value('client_first_name')?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    ...
                                                    <input type="text" class="form-control" id="client_last_name" name="client_last_name" required value="<?= set_value('client_last_name')?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    ...
                                                    <select class="form-control m-bot15" required id="client_county" name="client_county" value="<?= set_value('client_county')?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    ...
                                                    <input type="text" class="form-control" id="client_location" name="client_location" required value="<?= set_value('client_location')?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9">
                                                    ...
                                                    <input type="email" class="form-control" id="client_email" name="client_email" required value="<?= set_value('client_email')?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <input type="text" class="form-control" id="client_phone" name="client_phone" required value="<?= set_value('client_phone')?>">
