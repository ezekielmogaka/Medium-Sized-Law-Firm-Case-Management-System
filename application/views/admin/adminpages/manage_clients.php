                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box border blue">
                            <div class="box-title">
                                <h4><i class="fa fa-users"></i><?=$page_title?></h4>
                           ...
                           foreach ($clients as $client){
	                       	      ...
	                       	      <td>
                           	       ...
                           	       <td>
                           	       ".$client['client_countyName']."
                           	       </td>
	                       	      <td>
                           	       ".substr($client['client_description'], 0,200)."
                           	       </td>
                           	       ...
                           	       <td>
	                           	       <a href='".base_url()."index.php/admin/delete_client/".$client['client_id']."' class='btn btn-danger fa fa-trash-o'>Delete</a>
                           	       </td>
                           	       </tr>";
