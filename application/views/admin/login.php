...
<body class="login">	
    ...
    ?>
        ...
        ?>
								<h6 class="bigintro">Wakili Case Management System Admin Sign In</h6>
								<div class="divide-40"></div>
								<form role="form">
								  <div class="form-group">
									<label for="admin_email">Email address</label>
									<i class="fa fa-envelope"></i>
									<input type="email" class="form-control" name="admin_email"  value="<?= set_value('admin_email')?>" placeholder="Your Email" autofocus>
								  </div>
								  <div class="form-group"> 
