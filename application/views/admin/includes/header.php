<?php  
		...
		for($counter=0; $counter < count($attorneys); $counter++){
			...
			if(count($attorney_caseStatus) != 0){		
			

			if($attorney_caseStatus[0]['matter_status'] = $open)
			{
			$attorneys[$counter]['open'] = $this->db->get_where('matters', array('matter_status'=>$attorney_caseStatus[0]['matter_status']));
			...
			elseif ($attorney_caseStatus[0]['matter_status'] = $pending) {
				$attorneys[$counter]['pending'] = $this->db->get_where('matters', array('matter_status'=>$attorney_caseStatus[0]['matter_status']));

				$attorneys[$counter]['pending'] = $attorneys[$counter]['pending']->num_rows();
				...
				$attorneys[$counter]['closed'] = $this->db->get_where('matters', array('matter_status'=>$attorney_caseStatus[0]['matter_status']));
				$attorneys[$counter]['closed'] = $attorneys[$counter]['closed']->num_rows();
	...
	<header class="navbar clearfix navbar-fixed-top" id="header">
		<div class="container">
				<div class="navbar-brand">
					<!-- COMPANY LOGO -->
					<a href="index.html">
						<img src="<?= base_url()?>assets/img/logo/logo1.png" alt="Wakili CMS logo" class="img-responsive" height="30" width="120">
					</a>
					<!-- /COMPANY LOGO -->
				...
				<ul class="nav navbar-nav pull-left hidden-xs" id="navbar-left">
					<li class="dropdown">
						<a href="#" class="team-status-toggle dropdown-toggle tip-bottom" data-toggle="tooltip" title="Toggle Team View">
							<i class="fa fa-users"></i>
							<span class="name">Attorneys Cases Progress</span>
		  	...
		  	?>
				<li class="current">
				  ...
				  <span class="title">
					...
					<span class="status">
						<div class="field">
							<span class="badge badge-green"><?php
					...
					?>
						...
						<div class="field">
							<span class="badge badge-orange"><?php
					...
					?></span> Pending
						...
						<div class="field">
							<span class="badge badge-red"><?php
					echo 2;
