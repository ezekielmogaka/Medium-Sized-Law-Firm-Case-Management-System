...
<body class="login">	
	...
	<section id="page">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div id="logo">
								<a href="index.html"><img src="<?= base_url()?>assets/img/logo/logo1.png" height="80" alt="logo name" /></a>
							</div>
						</div>
					</div>
				</div>
     ...
     echo form_open('main/staff_login', $form_attributes);
    ...
    ?>
        ...
        ?>
								<h2 class="bigintro">Wakili Case Management System Attorney Login</h2>
								...
								<form role="form">
								  <div class="form-group">
									...
									<input type="email" class="form-control" name="staff_email" required placeholder="Email"  autofocus  value="<?= set_value('staff_email')?>" >
								  </div>
								  <div class="form-group"> 
									<label for="admin_pass">Password</label>
									<i class="fa fa-lock"></i>
									<input type="password" class="form-control" name="staff_password" placeholder="Password" required value="<?= set_value('staff_password')?>" >
								  </div>
								  <div>
