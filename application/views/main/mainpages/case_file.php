                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box border blue">
                            ...
                            <div class="box-body">
                                <div class="tabbable header-tabs">
                                    <ul class="nav nav-tabs">
                                        <li><a href="#box_tab5" data-toggle="tab"><i class="fa fa-magnet"></i> <span class="hidden-inline-mobile">Similar Cases</span></a></li>
                           ...
                           foreach ($matter_assigned as $case){
                            ?>
                                                <a href="<?= base_url()?>index.php/main/add_case_document/<?php echo $case['matter_id'];?>">
                                                    <button class="btn btn-success"><i class="fa fa-plus-circle"></i> Add case file Documents</button>
                                                </a>
                                                <?php
                          ...
                          ?>
                                        ...
                                        <div class="tab-pane fade" id="box_tab3">
                                            <div class="alert alert-info"><strong>Edit/Add Notes:</strong>
                                                <a href="<?= base_url()?>index.php/main/load_case_notes_edit/<?php echo $case['matter_id'];?>">
                                                    <button class="btn btn-success"><i class="fa fa-plus-circle"></i> New/Edit Notes</button>
                                                </a>
                           ...
                           foreach ($similar_cases as $similar){
                            $count=1;
                                 ...
                                 echo "<td> 
                                  ...
                                  <td>
                                   ...
                                   <td>
                                   ".$similar['matter_status']."
                                   </td>
                                  <td>
                                   ".substr($similar['matter_description'], 0,1000)."
                                   </td>
                                  
                                   <td>
                                   <a href='". base_url()."index.php/main/previous_case_file/".$similar['matter_id']."' target='_blank' class='btn btn-info fa fa-eye'>View</a>
                                   </td>
