                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box border green">
                            <div class="box-title">
                                <h4><i class="fa fa-table"></i><?=$page_title." - ".$name?></h4>
                           ...
                           foreach ($documents as $document){
	                       	      ...
	                       	      <td>
                           	       ...
                           	       <td>
                           	       <a href='". base_url()."assets/Documents/LegalDocuments/".$document['document_full_path']."' target='_blank' class='btn btn-info fa fa-eyes'>View</a>
                           	       </td>
