...
$(document).ready(function() {
    $('#document_category').change(function() { //any select change on the dropdown with id matter_category trigger this code
       $("#legal_document_subcategory > option").remove(); //first of all clear select items
        ...
        $.ajax({
            type: "POST",
            url: "http://localhost/firm/index.php/main/get_legal_document_subcategories/"+legal_document_cat_id, //here we are calling our main controller and get_matter_subcategories method passing the document_category_id
                ...
                <div class="row">
                 ...
                 <div class="form-group">
                          ...
                          <?php echo form_error('legal_document_subcategory'); ?>
                              ...
                              <select class="form-control m-bot15" id="legal_document_subcategory" name="legal_document_subcategory" value="<?php echo set_value('legal_document_subcategory'); ?>" required>
