...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/css/themes/default.css" id="skin-switcher">
    <!-- <link rel="stylesheet" type="text/css"  href="<?= base_url()?>assets/css/themes/night.css" id="skin-switcher" > -->
    <!-- <link rel="stylesheet" type="text/css"  href="<?= base_url()?>assets/css/themes/earth.css" id="skin-switcher" >
	<link rel="stylesheet" type="text/css"  href="<?= base_url()?>assets/css/themes/graphite.css" id="skin-switcher" >
	<link rel="stylesheet" type="text/css"  href="<?= base_url()?>assets/css/themes/nature.css" id="skin-switcher" >
	<link rel="stylesheet" type="text/css"  href="<?= base_url()?>assets/css/themes/utopia.css" id="skin-switcher" > -->
    ...
    <!-- WIZARD -->
    <link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/js/bootstrap-wizard/wizard.css" />
    <!-- UNIFORM -->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/js/colorbox/colorbox.min.css" />
</head>
...
<script type="text/javascript" src="<?= base_url()?>assets/js/colorbox/jquery.colorbox.min.js">
</script>
<!-- CUSTOM SCRIPT -->
<script src="<?= base_url()?>assets/js/script.js"></script>
<script src="<?= base_url()?>assets/js/bootstrap-wizard/form-wizard.min.js"></script>
<script>
