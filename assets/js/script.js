var App = function() {
    ...
    var handleDataTables = function() {
            ...
            $('#datatable2').dataTable({
                ...
                oTableTools: {
                    ...
                    sSwfPath: "../../assets/js/datatables/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
                }
            });
    ...
    var handleCalendar = function() {
            ...
            var addEvent = function(title) {
                title = title.length == 0 ? "My Event" : title;
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                select: function(start, end, allDay) {
                    ...
                    var eventTime = '<span style = "color:green">' + starttime + '</span>'+
                                    ' - \
                                    <span style = "color:green">' + endtime + '</span>';

                    $('#createEvent #when').html(eventTime);
                    $('#createEvent #eventStartTime').val(start);
                    $('#createEvent #eventEndTime').val(end);
                    $('#createEvent #eventAllDay').val(allDay);
                    ...
                    $.colorbox({
                        ...
                        onComplete:function(){
                            $('#submitEvent').click(function (e){
                                var attorney_id = $('input[name=attorney_id]').val();
                                var event = $('input[name=event]').val();
                                var startTime = $('#createEvent #eventStartTime').val();
                                var endTime = $('#createEvent #eventEndTime').val();
                               // var allDa y= $('#createEvent #eventAllDay').val();
                        ...
                        saveAttorneyEvents(attorneyId,event,startTime,endTime,allDay);
                        }
    ...
    var handleDashFlotCharts = function() {
            ...
            function chart_revenue() {
                ...
                var plot = $.plot($("#chart-revenue"), [{ data: likes }], {
                    series: {
                        label: "Cases",
                        lines: {
                            show: true,
    ...
    var handleGritter = function() {
            ...
            setTimeout(function() {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Welcome to Wakili Case Management System!',
                    // (string | mandatory) the text inside the notification
                    text: 'Welcome to Wakili Case Management System!!',
                    // (string | optional) the image to display on the left
                    //image: '../../assets/img/gritter/cloud.png',
            ...
            setTimeout(function() {
                var unique_id = $.gritter.add({
                    ...
                    text: 'Welcome to Wakili Case Management System!.',
                    // (string | optional) the image to display on the left
                   // image: '../../assets/img/gritter/settings.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function() {
                ...
                var unique_id = $.gritter.add({
                    ...
                    title: 'Welcome to Wakili Case Management System',
                    // (string | mandatory) the text inside the notification
                    text: 'Enjoy using the system',
                    // (string | optional) the image to display on the left
                    //image: '../../assets/img/gritter/buy.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
    ...
    return {
        ...
        blockUI: function(el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../../assets/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
